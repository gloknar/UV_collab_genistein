...
eSet_normalizado <- annotateEset(eSet_normalizado, pd.clariom.d.human, columns = c("ENTREZID", "SYMBOL", "GENENAME","ENSEMBL","ENSEMBLTRANS","REFSEQ","EVIDENCE"))
tail(fData(eSet_normalizado), n = 200L)
```
