...
```{r}
t_test_bayes = eBayes(diferencia_genisteina_control, trend = F)
```


Tras realizar el test t de Student moderado, procedemos a graficar la tendencia de la media-varianza para analizar la relación entre la expresión media y la varianza de cada gen: (mas info en https://www.ncbi.nlm.nih.gov/geo/info/geo2r.html#how_to_use)
...
La línea azul marca la susodicha tendencia Hay tendencia, luego hacemos trend =) T:
