...
saveRDS(eSet_normalizado, file = "eSet_normalizado.rds")
```
...
matriz_contrastes <- makeContrasts(Control - Genisteina, levels = matriz_diseno)
```
...
# saveRDS(DEG_limma, "tabla_resultados_total.rds")
```
