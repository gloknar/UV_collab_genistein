...
Puedes obtener los log<sub>2</sub> fold changes de la expresión de cada gen a través del hueco `$coefficients` (it's simply the difference between the mean log expression in mutant samples and the mean log expression in control samples):
