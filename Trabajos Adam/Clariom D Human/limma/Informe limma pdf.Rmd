...
Tras guardar los nombres de los genes diferencialmente expresados en el archivo de texto \verb|lista_DGE_limma.txt|, podemos realizar los análisis posteriores pertinentes (\textit{i.e.} GEA, GSEA, dianas de miRNA...).
