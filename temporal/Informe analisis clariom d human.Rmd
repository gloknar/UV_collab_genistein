...
```{r}
directorio_trabajo <- "C:/Users/Adam_/Desktop/microvesiculas - copia para trabajar/Resultados ClariomD_Human"
directorio_trabajo <- "./microvesiculas - copia para trabajar/Resultados ClariomD_Human"
```
...
A partir de la matriz de intensidades del microarray, podemos reconstruir su apariencia original con las siguientes líneas de código:

```{r, eval = F}
# Generamos paleta de colores verde -> amarillo -> rojo
colores_hibridacion <- rev(RColorBrewer::brewer.pal(n = 11, name = "RdYlGn"))

# Establecemos temporalmente la carpeta de trabajo en "imagenes_microarrays"
setwd("./Fotos arrays Clariom D Human/")

# Reconstruimos la apariencia original de los microarrays hibridados y guardamos
# las imágenes resultantes con resolución 720p en la carpeta
# "imagenes_microarrays"
...
# Reestablecemos la carpeta de trabajo original
setwd("./")
```

Las fotos reconstruidas se encuentran en la carpeta `Fotos arrays Clariom D Human`.


<details>
<summary>Click para ver imagen</summary>

![Muestra control nº1](./Fotos arrays Clariom D Human/Control_1.png)
<br>
