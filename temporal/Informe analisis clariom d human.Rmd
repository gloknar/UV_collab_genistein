...
# Protocolo de análisis de microarrays de ARNm Clariom D Human
...
```{r}
sampleNames(datos_crudos_microarrays) <- c("Control_1", "Genisteina_1", "Resveratrol_1", 
                                           "Control_2", "Genisteina_2", "Resveratrol_2",
                                           "Control_3", "Genisteina_3", "Resveratrol_3",
                                           "Control_4", "Genisteina_4", "Resveratrol_4")
...
* Las columnas son las muestras, en nuestro caso `Control_1`, `Genisteina_1`, `Resveratrol_1`... etc
...
pData(datos_crudos_microarrays)$condicion <- as.factor(rep(c("Control", "Genisteina", "Resveratrol"), times = 4))
...
for (i in pData(datos_crudos_microarrays)$muestra) {
  nombre.imagen = paste("imagen",i,".jpg",sep="")
  png(filename = nombre.imagen, width = 1920, height = 1080, units = "px", bg = "white")
  image(datos_crudos_microarrays[,i], 
        main = pData(datos_crudos_microarrays)$muestra[i])
  dev.off()
}
```
